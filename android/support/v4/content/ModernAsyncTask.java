...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C00451();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C02372();

    static class C00451 implements ThreadFactory {
    ...
    class C02372 extends WorkerRunnable<Params, Result> {
        C02372() {
        }
