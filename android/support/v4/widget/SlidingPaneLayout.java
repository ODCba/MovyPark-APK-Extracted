...
public class SlidingPaneLayout extends ViewGroup {
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C02711());
        boolean isOpen;

        static class C02711 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C02711() {
            }
