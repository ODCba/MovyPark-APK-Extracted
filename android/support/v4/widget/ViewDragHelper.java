...
public class ViewDragHelper {
    ...
    private static final Interpolator sInterpolator = new C01371();
    ...
    private final Runnable mSetIdleRunnable = new C01382();
    private int mTouchSlop;
    private int mTrackingEdges;
    private VelocityTracker mVelocityTracker;

    static class C01371 implements Interpolator {
        C01371() {
        }
