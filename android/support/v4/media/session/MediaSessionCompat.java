...
public class MediaSessionCompat {
    ...
    class C02471 extends Callback {
        C02471() {
        }
    }

    class C02482 extends Callback {
        C02482() {
        }
    }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        final String mTag;
        private final Token mToken;
        private android.support.v4.media.VolumeProviderCompat.Callback mVolumeCallback = new C02491();
        ...
        class C02491 extends android.support.v4.media.VolumeProviderCompat.Callback {
            C02491() {
            }
        ...
        class C02942 implements Callback {
            C02942() {
            }
