...
class TransportMediatorJellybeanMR2 {
    OnAudioFocusChangeListener mAudioFocusChangeListener = new C00814();
    boolean mAudioFocused;
    final AudioManager mAudioManager;
    final Context mContext;
    boolean mFocused;
    final OnGetPlaybackPositionListener mGetPlaybackPositionListener = new C00825();
    final Intent mIntent;
    final BroadcastReceiver mMediaButtonReceiver = new C00803();
    PendingIntent mPendingIntent;
    int mPlayState = 0;
    final OnPlaybackPositionUpdateListener mPlaybackPositionUpdateListener = new C00836();
    final String mReceiverAction;
    final IntentFilter mReceiverFilter;
    RemoteControlClient mRemoteControl;
    final View mTargetView;
    final TransportMediatorCallback mTransportCallback;
    final OnWindowAttachListener mWindowAttachListener = new C00781();
    final OnWindowFocusChangeListener mWindowFocusListener = new C00792();

    class C00781 implements OnWindowAttachListener {
        C00781() {
        }
    ...
    class C00792 implements OnWindowFocusChangeListener {
        C00792() {
        }
    ...
    class C00803 extends BroadcastReceiver {
        C00803() {
        }
    ...
    class C00814 implements OnAudioFocusChangeListener {
        C00814() {
        }
    ...
    class C00825 implements OnGetPlaybackPositionListener {
        C00825() {
        }
    ...
    class C00836 implements OnPlaybackPositionUpdateListener {
        C00836() {
        }
