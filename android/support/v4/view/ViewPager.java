...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C01111();
    ...
    private static final Interpolator sInterpolator = new C01122();
    ...
    private final Runnable mEndScrollRunnable = new C01133();
    ...
    static class C01111 implements Comparator<ItemInfo> {
        C01111() {
        }
    ...
    static class C01122 implements Interpolator {
        C01122() {
        }
    ...
    class C02604 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C02611());
        Parcelable adapterState;
        ClassLoader loader;
        int position;

        static class C02611 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C02611() {
            }
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C02604());
    }
