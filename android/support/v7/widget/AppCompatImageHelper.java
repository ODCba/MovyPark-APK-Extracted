...
*/
    ...
    L_0x000a:
        ...
        r4 = android.support.v7.appcompat.C0154R.styleable.AppCompatImageView;	 Catch:{ all -> 0x003c }
        r5 = 0;	 Catch:{ all -> 0x003c }
        r0 = android.support.v7.widget.TintTypedArray.obtainStyledAttributes(r3, r8, r4, r9, r5);	 Catch:{ all -> 0x003c }
        r3 = android.support.v7.appcompat.C0154R.styleable.AppCompatImageView_srcCompat;	 Catch:{ all -> 0x003c }
