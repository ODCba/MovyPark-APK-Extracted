...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = new int[]{C0154R.attr.actionBarSize, 16842841};
    ...
    class C03011 extends ViewPropertyAnimatorListenerAdapter {
        C03011() {
        }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C03011();
        this.mRemoveActionBarHideOffset = new C01612();
        this.mAddActionBarHideOffset = new C01623();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0154R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0154R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0154R.id.action_bar));
        }
    }
