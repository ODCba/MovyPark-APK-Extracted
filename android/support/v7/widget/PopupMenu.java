...
public class PopupMenu {
    ...
    class C01752 implements android.widget.PopupWindow.OnDismissListener {
        C01752() {
        }
    ...
    class C02851 implements Callback {
        C02851() {
        }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity) {
        this(context, anchor, gravity, C0154R.attr.popupMenuStyle, 0);
    }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity, @AttrRes int popupStyleAttr, @StyleRes int popupStyleRes) {
        ...
        this.mMenu.setCallback(new C02851());
        ...
        this.mPopup.setOnDismissListener(new C01752());
    }
