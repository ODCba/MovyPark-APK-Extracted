...
public abstract class ForwardingListener implements OnTouchListener {
    ...
    class C01711 implements OnAttachStateChangeListener {
        C01711() {
        }
    ...
    class C01722 implements OnGlobalLayoutListener {
    ...
    private void addDetachListenerApi12(View src) {
        src.addOnAttachStateChangeListener(new C01711());
    }

    private void addDetachListenerBase(View src) {
        src.getViewTreeObserver().addOnGlobalLayoutListener(new C01722());
    }
