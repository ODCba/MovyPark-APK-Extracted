...
public class MenuPopupHelper implements MenuHelper {
    ...
    class C01571 implements OnDismissListener {
        C01571() {
        }
    ...
    public MenuPopupHelper(@NonNull Context context, @NonNull MenuBuilder menu) {
        this(context, menu, null, false, C0154R.attr.popupMenuStyle, 0);
    }

    public MenuPopupHelper(@NonNull Context context, @NonNull MenuBuilder menu, @NonNull View anchorView) {
        this(context, menu, anchorView, false, C0154R.attr.popupMenuStyle, 0);
    }
    ...
    public MenuPopupHelper(@NonNull Context context, @NonNull MenuBuilder menu, @NonNull View anchorView, boolean overflowOnly, @AttrRes int popupStyleAttr, @StyleRes int popupStyleRes) {
        ...
        this.mInternalOnDismissListener = new C01571();
    ...
    private MenuPopup createPopup() {
        ...
        if (Math.min(displaySize.x, displaySize.y) >= this.mContext.getResources().getDimensionPixelSize(C0154R.dimen.abc_cascading_menus_min_smallest_width)) {
