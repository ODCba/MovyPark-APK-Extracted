...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, OnKeyListener, OnDismissListener {
    ...
    private final OnGlobalLayoutListener mGlobalLayoutListener = new C01551();
    private boolean mHasXOffset;
    private boolean mHasYOffset;
    private int mLastPosition;
    private final MenuItemHoverListener mMenuItemHoverListener = new C02792();
    ...
    class C01551 implements OnGlobalLayoutListener {
        C01551() {
        }
    ...
    class C02792 implements MenuItemHoverListener {
        C02792() {
        }
    ...
    public CascadingMenuPopup(@NonNull Context context, @NonNull View anchor, @AttrRes int popupStyleAttr, @StyleRes int popupStyleRes, boolean overflowOnly) {
        ...
        this.mMenuMaxWidth = Math.max(res.getDisplayMetrics().widthPixels / 2, res.getDimensionPixelSize(C0154R.dimen.abc_config_prefDialogWidth));
    ...
    private void showMenu(@NonNull MenuBuilder menu) {
        ...
        if (parentInfo == null && this.mShowTitle && menu.getHeaderTitle() != null) {
            ...
            View titleItemView = (FrameLayout) inflater.inflate(C0154R.layout.abc_popup_menu_header_item_layout, listView, false);
