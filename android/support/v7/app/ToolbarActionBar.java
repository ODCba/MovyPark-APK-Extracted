...
class ToolbarActionBar extends ActionBar {
    ...
    private final OnMenuItemClickListener mMenuClicker = new C02772();
    private final Runnable mMenuInvalidator = new C01531();
    ...
    class C02772 implements OnMenuItemClickListener {
        C02772() {
        }
...
*/
    ...
    private void ensureListMenuPresenter(Menu menu) {
        if (this.mListMenuPresenter == null && (menu instanceof MenuBuilder)) {
            ...
            this.mListMenuPresenter = new ListMenuPresenter(context2, C0154R.layout.abc_list_menu_item_layout);
