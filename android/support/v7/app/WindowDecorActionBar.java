...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C02981();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C02992();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C02783();

    class C02783 implements ViewPropertyAnimatorUpdateListener {
        C02783() {
        }
    ...
    class C02981 extends ViewPropertyAnimatorListenerAdapter {
        C02981() {
        }
    ...
    class C02992 extends ViewPropertyAnimatorListenerAdapter {
        C02992() {
        }
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0154R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0154R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0154R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0154R.id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0154R.styleable.ActionBar, C0154R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0154R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0154R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0154R.attr.actionBarWidgetTheme, outValue, true);
