...
public class ConstraintWidget implements Solvable {
    ...
    public void addToSolver(LinearSystem system, int group) {
        ...
        if (group == Integer.MAX_VALUE || (this.mLeft.mGroup == group && this.mRight.mGroup == group)) {
            ...
            int i = this.mX;
            int i2 = this.mX + width;
            float f = this.mHorizontalBiasPercent;
            boolean z = useRatio && dimensionRatioSide == 0;
            applyConstraints(system, wrapContent, horizontalDimensionFixed, constraintAnchor, constraintAnchor2, i, i2, width, f, z, inHorizontalChain);
        }
        ...
        if (this.mBaselineDistance > 0) {
            ...
            if (group == Integer.MAX_VALUE || (this.mTop.mGroup == group && end.mGroup == group)) {
                ...
                applyConstraints(system, wrapContent, verticalDimensionFixed, constraintAnchor3, end, i3, i4, height, f2, z2, false);
            }
            ...
            int i5 = this.mY;
            int i6 = this.mY + height;
            float f3 = this.mVerticalBiasPercent;
            boolean z3 = useRatio && dimensionRatioSide == 1;
            applyConstraints(system, wrapContent, verticalDimensionFixed, constraintAnchor4, constraintAnchor5, i5, i6, height, f3, z3, inVerticalChain);
        }
        if (useRatio) {
            row = system.createRow();
            if (group != Integer.MAX_VALUE && (this.mLeft.mGroup != group || this.mRight.mGroup != group)) {
