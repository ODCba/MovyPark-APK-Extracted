...
public class ConstraintAnchor {
    ...
    public void resetSolverVariable(Cache cache) {
        if (this.mSolverVariable == null) {
            this.mSolverVariable = new SolverVariable(cache, android.support.constraint.solver.SolverVariable.Type.UNRESTRICTED);
        } else {
    ...
    public String toString() {
        return this.mOwner.getDebugName() + ":" + this.mType.toString() + (this.mTarget != null ? " connected to " + this.mTarget : "");
    }
