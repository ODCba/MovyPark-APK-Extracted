            ...
            case 1:
                synchronized (this.zzaHP) {
                    ...
                    if (com_google_android_gms_common_internal_zzah != null && com_google_android_gms_common_internal_zzah.getState() == 3) {
                        ...
                        com_google_android_gms_common_internal_zzah.onServiceDisconnected(componentName == null ? new ComponentName(com_google_android_gms_common_internal_zzaf.getPackage(), EnvironmentCompat.MEDIA_UNKNOWN) : componentName);
                    }
                }
                return true;
            default:
