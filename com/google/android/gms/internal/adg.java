...
public final class adg {
    ...
    public final int zzLF() throws IOException {
        ...
        int i = zzLL & TransportMediator.KEYCODE_MEDIA_PAUSE;
        byte zzLL2 = zzLL();
        if (zzLL2 >= (byte) 0) {
            return i | (zzLL2 << 7);
        }
        i |= (zzLL2 & TransportMediator.KEYCODE_MEDIA_PAUSE) << 7;
        zzLL2 = zzLL();
        if (zzLL2 >= (byte) 0) {
            return i | (zzLL2 << 14);
        }
        i |= (zzLL2 & TransportMediator.KEYCODE_MEDIA_PAUSE) << 14;
        zzLL2 = zzLL();
        if (zzLL2 >= (byte) 0) {
            return i | (zzLL2 << 21);
        }
        i |= (zzLL2 & TransportMediator.KEYCODE_MEDIA_PAUSE) << 21;
        zzLL2 = zzLL();
        i |= zzLL2 << 28;
        if (zzLL2 >= (byte) 0) {
            return i;
    ...
    public final long zzLG() throws IOException {
        ...
        for (int i = 0; i < 64; i += 7) {
            byte zzLL = zzLL();
            j |= ((long) (zzLL & TransportMediator.KEYCODE_MEDIA_PAUSE)) << i;
            if ((zzLL & 128) == 0) {
                return j;
            }
        }
