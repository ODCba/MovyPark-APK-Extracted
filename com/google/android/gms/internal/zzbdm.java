...
public final class zzbdm {
    ...
    private zzbdm(Context context) {
        ...
        int identifier = resources.getIdentifier("google_app_measurement_enable", "integer", resources.getResourcePackageName(C0190R.string.common_google_play_services_unknown_issue));
        if (identifier != 0) {
