...
public abstract class zzbbe<R extends Result> extends PendingResult<R> {
    ...
    L_0x000b:
        return;
    L_0x000c:
        r2 = r5.zzaCd;	 Catch:{ all -> 0x0027 }
        if (r2 != 0) goto L_0x002a;
    L_0x0010:
        r2 = r0;
    L_0x0011:
        r4 = "Result has already been consumed.";
        com.google.android.gms.common.internal.zzbo.zza(r2, r4);	 Catch:{ all -> 0x0027 }
        r2 = r5.zzaCg;	 Catch:{ all -> 0x0027 }
        if (r2 != 0) goto L_0x002c;
    L_0x001a:
        r1 = "Cannot set callbacks if then() has been called.";
        com.google.android.gms.common.internal.zzbo.zza(r0, r1);	 Catch:{ all -> 0x0027 }
